...
STATIC mp_obj_t extra_coverage(void) {
    ...
    // mp_obj_is_type and derivatives
    {
        ...
        // mp_obj_is_type_unsafe(&mp_type_int) doesn't accept small ints but accepts object ints
        mp_printf(&mp_plat_print, "%d %d\n", mp_obj_is_type_unsafe(MP_OBJ_NEW_SMALL_INT(1), &mp_type_int), mp_obj_is_type_unsafe(mp_obj_new_int_from_ll(1), &mp_type_int));
